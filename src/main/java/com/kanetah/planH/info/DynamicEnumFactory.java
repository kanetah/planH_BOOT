...
//
//        addEnum(TaskInfoAttribute.class, "d",
//                new Class[]{String.class},
//                new Object[]{"测试3"});
//
//        addEnum(TaskInfoAttribute.class, "e",
//                new Class[]{String.class},
//                new Object[]{"测试4"});
//
//        addEnum(TaskInfoAttribute.class, "f",
//                new Class[]{String.class},
//                new Object[]{"测试5"});
//
//        System.out.println(Arrays.deepToString(TaskInfoAttribute.values()));
//    }
}